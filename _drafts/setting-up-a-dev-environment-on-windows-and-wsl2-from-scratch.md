...
### Linux (Ubuntu) [![Ubuntu](/assets/img/posts/2022/02/setting-up-dev-env/UbuntuCoF.svg){: .right w="128"}](https://ubuntu.com)
...
### Chocolatey & Windows command line utilities [![Chocolatey](/assets/img/posts/2022/02/setting-up-dev-env/choco-logo-square.svg){: .right w="128"}](https://chocolatey.org)
...
### Git for Windows [![Git for Windows](/assets/img/posts/2022/02/setting-up-dev-env/git-bash.svg){: .right w="128"}](https://gitforwindows.org/)
...
![Run as administrator](/assets/img/posts/2022/02/setting-up-dev-env/run-git-install-as-admin.png)
...
Here are the ..... **HERE HERE HEREEE ALLO! COUCOU!**

---

### Windows Terminal [![Windows Terminal](/assets/img/posts/2022/02/setting-up-dev-env/Windows_Terminal_logo.svg){: .right w="128"}](https://github.com/Microsoft/Terminal)
...
![Ubuntu Icon](/assets/img/posts/2022/02/setting-up-dev-env/ubuntu_icon.png){: .left}
...
[![VS Code](/assets/img/posts/2022/02/setting-up-dev-env/Visual_Studio_Code_1.35_icon.svg){: .right w="128"}](https://code.visualstudio.com/)

Next up in the install list is Visual Studio Code. This is a source code editor, verging an to an IDE. It doesn't come right out of the box with all the builds and debugging abilities one can expect from an actual IDE, but with its extensive set of extensions, it sure can feel like one sometimes. It also starts blazingly fast! There was a talk a few years back on that topic: [VS Code: The First Second](https://www.youtube.com/watch?v=XgDus4lPmR8). It's worth checking if you have a interest in performance.
...
Last thing I'd like to have installed on the Windows side of things is [Fork](https://git-fork.com/), an excellent GUI for git. I think it's important to be able to know how to do most of the work that one needs to do with git on the command line, but there are definitely some that can benefit from a good user interface (e.g. some more complex rebases are much more pleasant to do using Fork).

The tool can be used for free, but the developers ask that you buy a license, which I did. Their tool is very well done, very useful, and the $50 license is worth every penny.
